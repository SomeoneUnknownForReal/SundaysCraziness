...
pygame.font.init()
font = pygame.font.Font(os.path.join(here, "fonts/default.ttf"), 48)
fontmedium = pygame.font.Font(os.path.join(here, "fonts/default.ttf"), 36)
fontsmall = pygame.font.Font(os.path.join(here, "fonts/debug.ttf"), 16)
...
def gameover():
  ...
  mixer.music.stop()
  gmobtn = pygame_gui.elements.UIButton(pygame.Rect(screen.get_width()/2-50, screen.get_height()/2-20, 100, 40), "Restart", manager=gameovermanager, command=game)
  while True:
    screen.fill((0,0,0))
    gameovermanager.update(clock.get_fps()/1000)
    gameovermanager.draw_ui(screen)
